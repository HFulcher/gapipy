...
class Account(object):
    ...
    def __repr__(self):
        return "<gapipy.account.Account object: {} ({})>".format(
            self.name, self.id)
...
class WebProperty(object):
    ...
    def __repr__(self):
        return "<gapipy.account.WebProperty object: {} ({})>".format(
            self.name, self.id)
...
class Profile(object):
    ...
    def __repr__(self):
        return "<gapipy.account.Profile object: {} ({})>".format(
            self.name, self.id)
...
class ReportingAPI(object):
    ...
    def __repr__(self):
        return '<gapipy.account.{} object>'.format(self.__class__.__name__)
