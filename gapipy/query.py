...
class Report(object):
    ...
    def __repr__(self):
        ...
        if len(dimensions):
            return '<gapipy.query.Report object: {} by {}'.format(
                metrics, dimensions)
        else:
            return '<gapipy.query.Report object: {}'.format(
                metrics)
...
class Query(object):
    ...
    def __repr__(self):
        return "<gapipy.query.{} object: {} ({})>".format(self.__class__.__name__, self.title, self.profile.name)
